require"octo".setup({
  ...
  mappings = {
    ...
    review_thread = {
      ...
      next_comment = { lhs = ")c", desc = "go to next comment" },
      prev_comment = { lhs = "(c", desc = "go to previous comment" },
      select_next_entry = { lhs = ")e", desc = "move to next changed file" },
      select_prev_entry = { lhs = "(e", desc = "move to previous changed file" },
      select_first_entry = { lhs = "(E", desc = "move to first changed file" },
      select_last_entry = { lhs = ")E", desc = "move to last changed file" },
